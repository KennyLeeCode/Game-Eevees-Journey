...
// Each Eeveelution lives in a specific zone on the map
// maxHp determines how much health they have in battle
public enum Eeveelution {
    ...
    // Returns which Eeveelution lives in a given tile zone, or null if none
